...
describe("websocket reducer", () => {
    ...
    test("should handle wsConnecting", () => {
      expect(
        wsReducer(undefined, wsConnecting)
      ).toEqual({
        ...initialState,
    ...
    test("should handle wsClose", () => {
      ...
      test("should handle wsError", () => {
        const error = "error"
        expect(
          wsReducer(undefined, wsError(error))
        ).toEqual({
          ...initialState,
      ...
      test("should handle wsMessage", () => {
        const orders = ["a","b"]
        expect(
          wsReducer(undefined, wsMessage(orders))
        ).toEqual({
          ...initialState,
          orders: orders,
        });
