...
export const ResetPasswordPage = () => {
    ...
    const loading = useSelector((store) => store.resetPassword.change_password_loading);
    const error = useSelector((store) => store.resetPassword.change_password_error);
    const success = useSelector((store) => store.resetPassword.change_password_success);
    const reset = () => {
